...
logAnimalSightings("Cheeta", "Rhino", "Tiger", "Wolf");
...
/*
 * Observations:
 * Because the spread function creates a shallow copy, any changes to the copy doesn't affect the original
 */
...
/*
 * Observations:
 * Since nested properties are "referenced" and not copied, nested properties can be changed and update the original.
 */
